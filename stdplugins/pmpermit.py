...
BAALAJI_TG_USER_BOT = "`Chand pa hai apun aana tak wait karo,tag him in @Uzumakilover`"
...
UNIBORG_USER_BOT_NO_WARN = "`. Daar ki yahi dikkat hain kabhi bhi khatam ho sakta hai. Tag me in @Uzumakilover`"
